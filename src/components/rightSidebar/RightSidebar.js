...
import { FaAngleDoubleRight, FaCloudSun, FaTrafficLight, FaBalanceScale, FaUsers } from "react-icons/fa";
                ...
                <div>
                    <div className="mainView" style={(view === "main") ? { display: "block" } : { display: "none" }}>
                        <div className="impactSection section">
                            ...
                            <EnvironmentalImpact {...{ currentRoute, travelStats }} />

                        </div>
                        <div className="discoverSection section">
                            <h3><IoLocationSharp /> Discover</h3>
                            <button className="sectionButton" onClick={() => setView("attractions")}>Show nearby sustainable attractions</button>
                        </div>
