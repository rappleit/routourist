...
const CountryInfo = () => {
    ...
    const malaysiaInfo = {
        Law: [
            ...
            "Strict Drug Laws",
            "Restricted Religious Activities, prohibited to preselytizing Muslims",
        ],
        Culture: [
            "Languages Spoken: Malay, English",
            "Multicultural society, mainly made out of Malay, Chinese and Indian",
            "Multireligious society, mainly Islam, Buddhism and Christianity",
            "The monarchy is highly respected",
        ],
        Weather: [
            "Tropical Climate",
            "From 25°C to 35°C",
    ...
    const singaporeInfo = {
        Law: [
            ...
            "CCTV cameras are common",
        ],
        Culture: [
            "Languages Spoken: English, Chinese, Malay and Tamil",
            "Multicultural society, mainly made out of Chinese, Malay and Indian",
            "Multireligious society, mainly Buddhism, Christianity and Islam",
        ],
        Weather: ["Tropical Climate", "From 25°C to 31°C"],
    };
    ...
    return (
        <div className="countryinfo_section">
            <div className="head_section">
                <h1>
                    Things to note in{" "}
                    <span className="country_section">{country}</span>
                </h1>
                <div className="buttons_section">
                    <button onClick={() => setChange("country")}>
                        Select Country
                    </button>
                    ...
                    <div className="button_description">
                        <ul>
                            <li>
                                To go back to country selection, click 'Select
                                Country'
                            </li>
                            <li>
                                If you wish to discover places in {country},
                                click 'Preset Route'
                            </li>
                            <li>
                                If you wish to build your multi destination
                                route, click 'Build Route'
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div className="information_section">
                <div
                    className="law_section"
                    onClick={() => setOpen("law_info")}
                >
                    <h3>Law</h3>
                    <BsChevronDown className="arrowdown" />
                </div>
                {lawinfo && <ul className="law_info">{LawPoints}</ul>}

                <div
                    className="culture_section"
                    onClick={() => setOpen("culture_info")}
                >
                    <h3>Culture</h3>
                    <BsChevronDown className="arrowdown" />
                </div>
                {cultureinfo && (
                    <ul className="culture_info">{CulturePoints}</ul>
                )}

                <div
                    className="weather_section"
                    onClick={() => setOpen("weather_info")}
                >
                    <h3>Weather</h3>
                    <BsChevronDown className="arrowdown" />
                </div>
                {weatherinfo && (
                    <ul className="weather_info">{WeatherPoints}</ul>
                )}
            </div>
            ...
            {country == "Singapore" ? (
                <div className="sus_events">
                    <div className="event_box">
                        ...
                        <div>
                            <a
                                target="_blank"
                                href="https://www.ilightsingapore.gov.sg/about/the-festival/"
                            >
                                Learn More
                            </a>
                        </div>
                    ...
                    <div className="event_box">
                        <div>
                            <h3 className="event_header">
                                Nature and Sustainability Tour: Biodiversity and
                                Ecosystems
                            </h3>
                            <h4 className="event_sub">10-25 June 2023</h4>
                            <h4 className="event_sub">
                        ...
                        <div>
                            <a
                                target="_blank"
                                href="https://www.eventbrite.sg/e/nature-and-sustainability-tour-biodiversity-and-ecosystems-jun-tickets-616912300297?aff=ebdssbdestsearch&keep_tld=1"
                            >
                                Learn More
                            </a>
                        </div>
                    ...
                    <div className="event_box">
                        ...
                        <div>
                            <a
                                target="_blank"
                                href="https://www.eventbrite.sg/e/farm-visit-to-hay-dairies-bollywood-farm-tickets-635282175087?aff=ebdssbdestsearch"
                            >
                                Learn More
                            </a>
                        </div>
                    ...
                    <div className="event_box">
                        <div>
                            <h3 className="event_header">
                                Farm Visit to Hay Dairies & Bollywood Farm
                            </h3>
                            <h4 className="event_sub">10 June 2023</h4>
                            <h4 className="event_sub">
                                Hay Dairies Pte Ltd 3 Lim Chu Kang Lane 4
                                Singapore, 718859
                            </h4>
                        </div>
                        <div>
                            <a
                                target="_blank"
                                href="https://www.singaporeexpo.com.sg/sg/what-s-on/events-expo/Yummy-Food-Expo-2023-"
                            >
                                Learn More
                            </a>
                        </div>
                ...
                <div className="sus_events">
                    <div className="event_box">
                        ...
                        <div>
                            <a target="_blank" href="https://rwmf.net/">
                                Learn More
                            </a>
                        </div>
                    </div>
                    <div className="event_box">
                        ...
                        <div>
                            <a
                                target="_blank"
                                href="https://georgetownfestival.com/2023/"
                            >
                                Learn More
                            </a>
                        </div>
                    ...
                    <div className="event_box">
                        ...
                        <div>
                            <a target="_blank" href="https://www.mide.com.my/">
                                Learn More
                            </a>
                        </div>
                    </div>
                    ...
                    <div className="event_box">
                        <div>
                            ...
                            <h4 className="event_sub">
                                ...
                                and Resort World Langkawi, RWL
                            </h4>
                        </div>
                        <div>
                            <a
                                target="_blank"
                                href="https://limamalaysia.com.my/"
                            >
                                Learn More
                            </a>
                        </div>
                ...
                <div className="sus_locations">
                    <div className="event_box">
                        <div>
                            ...
                            <h4 className="event_sub">
                                #02-18, Funan Mall, 107 North Bridge Rd, 179105
                            </h4>
                        </div>
                        <div>
                            <a
                                target="_blank"
                                href="https://www.thegreencollective.sg/"
                            >
                                Learn More
                            </a>
                        </div>
                    ...
                    <div className="event_box">
                        ...
                        <div>
                            <a
                                target="_blank"
                                href="https://bamboostrawgirl.com/pages/about-us"
                            >
                                Learn More
                            </a>
                        </div>
                    ...
                    <div className="event_box">
                        <div>
                            ...
                            <h4 className="event_sub">
                                21 Bukit Batok Cres, #06-78 Wcega Tower,
                                Singapore 658065
                            </h4>
                        </div>
                        <div>
                            <a
                                target="_blank"
                                href="https://thesustainabilityproject.life/"
                            >
                                Learn More
                            </a>
                        </div>
                ...
                <div className="sus_locations">
                    <div className="event_box">
                        <div>
                            ...
                            <h4 className="event_sub">
                                3437, Jalan, Mukim, Kampung Baru Pantai, 71770
                                Seremban, Negeri Sembilan, Malaysia
                            </h4>
                        </div>
                        <div>
                            <a target="_blank" href="https://thedusun.com.my/">
                                Learn More
                            </a>
                        </div>
                    </div>
                    ...
                    <div className="event_box">
                        <div>
                            ...
                            <h4 className="event_sub">
                                3, Jalan 26/70a, Desa Sri Hartamas, 50300 Kuala
                    ...
                    <div className="event_box">
                        <div>
                            ...
                            <h4 className="event_sub">
                                Jalan Bukit Bendera, Bukit Bendera, 11500 Bukit
                                Bendera, Pulau Pinang, Malaysia
                            </h4>
                        </div>
                        <div>
                            <a target="_blank" href="https://thehabitat.my/">
                                Learn More
                            </a>
                        </div>
                    </div>
                    <div className="event_box">
                        <div>
                            ...
                            <h4 className="event_sub">
                                56 Jalan Tabuan,93100 Kuching,Sarawak
                            </h4>
                        </div>
                        <div>
                            <a target="_blank" href="https://tanoticrafts.com/">
                                Learn More
                            </a>
                        </div>
                    </div>
